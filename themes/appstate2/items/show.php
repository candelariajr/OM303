...
<ul class="item-pagination navigation">
    <li id="previous-item-top-page" class="previous">
        <?php echo link_to_previous_item_show();?>
    </li>
    <li id="next-item-top-page" class="next">
...
<div id="primary">
    ...
    <?php
	    ...
	    else if(strtoupper($file_extension) == 'MP4'){
		echo files_for_item(array('imageSize' => 'small'));
	    }
	    else{
		echo "<div id='item-image-container'>".files_for_item(array('imageSize' => 'fullsize'))."</div>";	
		//echo get_specific_plugin_hook_output('DocsViewer', 'public_items_show', array('view' => $this, 'item' => $item));
	    }
	    //echo get_specific_plugin_hook_output('UniversalViewer', 'public_items_show', array('view' => $this, 'item' => $item));
	}
...
<div id="secondary">
    ...
    <div id="item-citation" class="element">
        ...
        <div class="element-text">
            <form id="requestcopy" action="https://collections.library.appstate.edu/duplications">
